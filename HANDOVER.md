...
|---|---|
| 版本 | **v2026.09.21.5** |
| 签发时间 | 2026-09-21 15:19 本机时间 |
| 基于提交 | `869d0bd` + 本次发布提交 |
| 本次说明 | 学习循环第 1 期复核修正：PWA 图标/缓存、自上次访问口径、判定卡数据档、手机可用性、ics 规范化、推送漏报与静默（22+5 处，均经对抗性核实） |
| 规则数 | 115 |
| 指标数 / 新闻数（最近构建） | 1896 / 600（数据日 2026-09-21） |
| 学习来源 / 方法论 / 功能候选(已上线) | 65 / 25 / 19(5) |
| Release | https://github.com/awakenedallianc/opportunity-monitor/releases/tag/v2026.09.21.5 |
<!-- AUTO:END -->
